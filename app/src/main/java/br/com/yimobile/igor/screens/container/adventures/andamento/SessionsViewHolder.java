...
public class SessionsViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {

    Context context;
    TextView titleTextView;

    public SessionsViewHolder(View itemView, Context context) {
        super(itemView);
